        ...
        <div class="appContent">
            ...
            <div page='policy'>
                <div class="">
                    ...
                    <div>
                        <img src="/files/images/privacyPolicy/PrivacyPolicy.png" alt="">
                        <div class="font-bold">#ПОЛИТИКА КОНФИНДЕНЦИАЛЬНОСТИ</div>
                    </div>
                    <div>
                        <div>
                            ...
                            <br>1.2. Настоящая политика Оператора в отношении обработки персональных данных (далее – Политика) применяется ко всей информации, которую Оператор может получить о посетителях веб-сайта <a href="<?= __HOST__; ?>"><?= __HOST__; ?></a>.
                            ...
                            <br>2.3. Веб-сайт – совокупность графических и информационных материалов, а также программ для ЭВМ и баз данных, обеспечивающих их доступность в сети интернет по сетевому адресу <a href="<?= __HOST__; ?>"><?= __HOST__; ?></a>.
                            ...
                            <br>2.8. Персональные данные – любая информация, относящаяся прямо или косвенно к определенному или определяемому Пользователю веб-сайта <a href="<?= __HOST__; ?>"><?= __HOST__; ?></a>.
                            ...
                            <br>2.10. Пользователь – любой посетитель веб-сайта <a href="<?= __HOST__; ?>"><?= __HOST__; ?></a>.
                            ...
                            <br>3.1. Оператор имеет право:<br>
                            ...
                            <br>– публиковать или иным образом обеспечивать неограниченный доступ к настоящей Политике в отношении обработки персональных данных по адресу <a href="<?= __HOST__; ?>/privacy"><?= __HOST__; ?>/privacy/</a>.
                        </div>
                    </div>
